...
/** 
*
* acp_forums [Swedish] (phpBB 3.0.6)
*
* @package language
* @version $Id$
...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUICK_REPLY_EXPLAIN'	=> 'Om satt till ja så får användare en snabbsvarsmöjlighet för denna kategori. Om den globala inställningen för snabbsvar är satt till Nej, så åsidosätts denna inställning.',
