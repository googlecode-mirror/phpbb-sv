...
/** 
*
* acp_forums [Swedish] (version for phpBB 3.0.3)
*
* @package language
* @version $Id$
...
$lang = array_merge($lang, array(
	...
	'LIST_SUBFORUMS_EXPLAIN'	=> 'Visar denna kategoris underkategorier på indexsidan och på andra ställen som en länk inom legenden om dess "Lista underkategori i ovanliggande kategoris legend" inställning är aktiverad.',
