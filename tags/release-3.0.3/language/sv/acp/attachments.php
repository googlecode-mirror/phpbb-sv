...
/** 
*
* acp_attachments [Swedish] (version for phpBB 3.0.3)
*
* @package language
* @version $Id$
...
$lang = array_merge($lang, array(
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> 'Maximal storlek på en fil som laddas upp i ett personligt meddelande. 0 för obegränsat.',
	'ATTACH_MAX_PM_FILESIZE'			=> 'Maximal filstorlek för personliga meddelanden',
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> 'Maximal storlek för en fil i personliga meddelanden, 0 är obegränsat.',
