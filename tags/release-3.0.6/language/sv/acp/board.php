...
$lang = array_merge($lang, array(
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'Inställningen påverkar om snabbsvar är aktiverat eller inte. Om aktiverat, så ska även kategorierna ha snabbsvar aktiverat för att det ska fungera.',
...
$lang = array_merge($lang, array(
	...
	'MIN_CHAR_LIMIT_EXPLAIN'		=> 'Definierar minsta antal tecken som bör skrivas in i ett inlägg eller personligt meddelande',
	'POSTING'						=> 'Inlägg',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> 'Nya medlemmar läggs automatiskt i den fördefinierade gruppen <em>Nya medlemmar</em> tills de uppnår denna mängd inlägg. Du kan använda denna grupp för att förhindra användning av pm eller granska inlägg före de blir postade i forumet.<strong>Sätt till 0 för att helt  inaktivera denna egenskap</strong>',
	'NEW_MEMBER_GROUP_DEFAULT'		=> 'Ange gruppen Nya medlemmar som standard',
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> 'Aktivera detta och definiera antal inlägg för gruppen Nya medlemmar för att lägga in nya medlemmar i gruppen Nya medlemmar och ange den gruppen som deras standardgrupp. Dett akan vara behändigt om man vill ange en grupptitel eller visningsbild för nya medlemmar.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_OVERALL_FORUMS'			=> 'Aktivera globalt kategoriflöde',
	'ACP_FEED_OVERALL_FORUMS_EXPLAIN'	=> 'Detta flöde visar de senaste inläggen från trådar i alla kategorier.',
	'ACP_FEED_OVERALL_FORUMS_LIMIT'		=> 'Antal inlägg att visa per sida i kategoriflödet',

	'ACP_FEED_OVERALL_TOPIC'			=> 'Aktivera globalt trådflöde',
	'ACP_FEED_OVERALL_TOPIC_EXPLAIN'	=> 'Aktiverar “Alla trådar”-flödet',
	'ACP_FEED_OVERALL_TOPIC_LIMIT'		=> 'Antal inlägg att visa per sida i trådflödet',
	...
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'		=> 'Innehållet från dessa kategorier  <strong>kommer inte att ingå i flöden.</strong>. Välj ingen kategori för att använda inlägg från alla kategorier.<br />Använd t.ex. kombinationen <samp>CTRL</samp> + musklick för att markera och välja (avvälja) fler än en kategori.',
));
...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_GD_WAVE'							=> 'GD CAPTCHA böljande förvrängning',
	'CAPTCHA_GD_WAVE_EXPLAIN'					=> 'Använd en böljande förvrängning av CAPTCHAn.',
	'CAPTCHA_GD_3D_NOISE'					=> 'Lägg till 3D-brus',
	'CAPTCHA_GD_3D_NOISE_EXPLAIN'			=> 'Använd extra objekt ovanför bokstäverna i CAPTCHAn.',
	'CAPTCHA_GD_FONTS'						=> 'Olika teckensnitt',
	...
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'CAPTCHAn som den kommer se ut med de nuvarande inställningarna.',
	'CAPTCHA_SELECT'						=> 'Installerade tillägg för CAPTCHA',
	'CAPTCHA_SELECT_EXPLAIN'				=> 'Listrutan visar de CAPTCHA tillägg, som forumet känner igen. Grå val är inte tillgängliga just nu och kan behöva justeras före de är användbara.',
	'CAPTCHA_CONFIGURE'						=> 'Ställ in CAPTCHAn',
	'CAPTCHA_CONFIGURE_EXPLAIN'				=> 'Ändra inställningarna för den valda CAPTCHAn.',
	'CONFIGURE'								=> 'Ställ in',
	'CAPTCHA_NO_OPTIONS'					=> 'Den här CAPTCHAn har inga inställningar.',

	'VISUAL_CONFIRM_REFRESH'				=> 'Tillåt användaren uppdatera konfirmationskoden',
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> 'Användaren kan be om en ny bild, om man inte ser den första visuella verifieringskoden tillräckligt bra.',
	...
	'VISUAL_CONFIRM_REG_EXPLAIN'			=> 'Kräver att nya användare skriver in en slumpmässig kod matchande en bild för att förhindra massregistreringar. Vissa tillägg tillåter inte detta.',
));
...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Om detta inaktiveras så kommer forumet inte att skicka ut några e-postmeddelanden över huvud taget.<em>Notera att detta inte är kompatibelt med inställningen för administratörs- eller användaraktivering av konton.</em>',
