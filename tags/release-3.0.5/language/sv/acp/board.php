...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUEUE_TRIGGER'			=> 'Aktivera inläggskön',
  'ENABLE_QUEUE_TRIGGER_EXPLAIN'	=> 'Här kan du välja att lägga registrerade medlemmars inlägg i modereringskö ifall de har färe inlägg en värdet du angett under. Denna inställning åsidosätter inte behörigheterna för godkännanden av inlägg/tråd.', 
	'QUEUE_TRIGGER_POSTS'			=> 'Maximalt antal inlägg för inläggskön',
 	'QUEUE_TRIGGER_POSTS_EXPLAIN'	=> 'Om inläggskön är aktiverad, så är detta antalet inlägg en medlem måste ha, för att kunna skriva inlägg utan godkännande. Inlägg, skrivna av medlemmar med färre inlägg, hamnar automatiskt i kön.',
